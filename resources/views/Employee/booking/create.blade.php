...
<div class="container mt-5">
    ...
    <form action="{{ route('Employee.booking.store') }}" method="POST" class="p-4 shadow rounded bg-light">
        @csrf
        ...
        <div class="text-center">
            ...
            <a href="{{ route('Employee.booking.index') }}" class="btn btn-secondary">Cancel</a>
        </div>
    </form>
</div>
@endsection
