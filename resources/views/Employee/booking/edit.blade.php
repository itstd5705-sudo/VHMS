...
<div class="container mt-5">
    ...
    <form action="{{ route('employee.booking.update', $booking->id) }}" method="POST" class="p-4 shadow rounded bg-light">
        @csrf
        @method('PUT')
        ...
        <div class="text-center">
            ...
            <a href="{{ route('employee.booking.index') }}" class="btn btn-secondary">Back</a>
        </div>
    </form>
</div>
@endsection
